...
@Component({
    selector: 'ngx-tip-dragger',
    templateUrl: './tip-dragger.component.html',
    styleUrls: ['./tip-dragger.component.scss'],
})
export class TipDraggerComponent implements AfterViewInit, OnChanges {
    ...
    private invalidate(): void {
        this.bottomAngleRad = TipDraggerComponent.toRad(this.bottomAngle);
        this.calculateVars();
